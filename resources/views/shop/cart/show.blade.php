...
@section('content')
    <div class="box">
        ...
        <div class="ui attached fluid clearing segment">
            <h3 class="ui dividing header">@lang('shop.cart.cart_summary')</h3>
            ...
            @if($cart->isNotEmpty())
                <h3 class="ui dividing header">@lang('shop.cart.buy_summary')</h3>
                    ...
                    <section class="ui stackable grid">
                        ...
                        <div class="height wide column">
                            <form class="ui form" action="{{ route('shop.cart.buy') }}" method="POST">
                                ...
                                <button type="submit" class="ui fluid primary button">@lang('shop.cart.buy')</button>
                            </form>
                        </div>
                    </section>
                @else
                    <div class="ui error message">
                        <p>@lang('shop.cart.no_chars')</p>
                    </div>
                @endif
            @endif
        </div>
