    ...
    <section class="container">
        <nav class="ui vertical menu">
            ...
            <div class="item">
                ...
                <div class="menu">
                    <a class="item activable left icon" href="{{ route('admin.article.index') }}"><i class="list icon"></i>@lang('admin/nav.article.browse')</a>
                    <a class="item activable left icon" href="{{ route('admin.article.create') }}"><i class="plus icon"></i>@lang('admin/nav.article.add')</a>
                </div>
            </div>
